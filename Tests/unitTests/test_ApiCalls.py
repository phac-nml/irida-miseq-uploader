...
def load_test_suite():
    ...
    api_test_suite.addTest(
        TestApiCalls("test_get_link_invalid_targ_dict_value"))
    ...
    api_test_suite.addTest(
        TestApiCalls("test_get_projects_invalid_missing_key"))
    ...
    api_test_suite.addTest(
        TestApiCalls("test_get_sequence_files_invalid_proj"))
    api_test_suite.addTest(
        TestApiCalls("test_get_sequence_files_invalid_sample"))
    ...
    api_test_suite.addTest(
        TestApiCalls("test_send_project_invalid_server_res"))
